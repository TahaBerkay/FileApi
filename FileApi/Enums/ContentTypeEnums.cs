...
namespace FileApi.Enums
{
    ...
    {
        private static object GetMetadata(ContentTypeEnums ct)
        {
            var type = ct.GetType();
        ...
        public static string ToValue(this ContentTypeEnums ct)
        {
            var metadata = GetMetadata(ct);
            return (metadata != null) ? ((Metadata)metadata).Value : ct.ToString();
        }

        public static bool IsText(this ContentTypeEnums ct)
        {
            var metadata = GetMetadata(ct);
            return (metadata != null) ? ((Metadata)metadata).IsText : true;
        }

        public static bool IsBinary(this ContentTypeEnums ct)
        {
            var metadata = GetMetadata(ct);
